...
- например, проектный файл `output\grok_portraits\portrait.png` попадет в `E:\Git\P_h_o_t_o\Dv_Yakov_1\Dv_Yakov\2026\output\grok_portraits\portrait.png`;

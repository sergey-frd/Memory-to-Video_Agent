...
from api.openai_video_prompt_composer import (
    ...
    synthesize_seedance_json_prompt_with_openai,
)
...
def main() -> None:
    ...
    if args.seedance_json:
        ...
        seedance_json_text = synthesize_seedance_json_prompt_with_openai(
            request=request,
            reference_contexts=reference_contexts,
        ...
        print(f"Seedance JSON prompt saved to: {seedance_prompt_path}")

...
The public bundle now includes a limited code snapshot: `code/main.py`, `code/config.py`, `code/config.json`, plus selected Python sources under `code/api/` and `code/utils/`.

...
Публичный bundle теперь также включает ограниченный code snapshot: `code/main.py`, `code/config.py`, `code/config.json`, а также выбранные Python-исходники в `code/api/` и `code/utils/`.

...
## 2026.09.23.03 — варианты портрета и воспроизводимость

- Описаны художественный, содержательный, интегрированный и альтернативный подходы; рекомендованный маршрут для нового героя и отдельный выбор FULL/SHORT.
- Документированы реализованные coverage/semantic_ratio, равноправие типов медиа, готовый edit plan и явная карта скриптов/конфигураций.
- Зафиксированы последовательные native-подготовка, SHORT, приёмка, FULL и отдельный экспорт; структурная проверка не подменяет визуальную.
- Персональные инструкции и launchers исключены из публикации; полная история остаётся в локальном архиве.
- Универсальный конфиг свободной integrated/expanded/alternative-сборки обозначен как будущий интерфейс, а не реализованная функция.

...
def _framing_mode_prompt_requirements(
    ...
    if framing_mode == VideoFramingMode.AI_OPTIMAL:
        return (
            "6. Choose the camera framing that feels most cinematic and effective for the source image, but do not let the face become significantly enlarged or distorted.\n"
            "7. A somewhat closer portrait scale is acceptable only when facial proportions stay stable, natural, and identity-safe.\n"

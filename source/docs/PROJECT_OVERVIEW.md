...
- Generated at: `2026-04-02T19:08:56+02:00`
...
| `grok_runtime` | Запуск Grok для single-stage и batch сценариев (web и прямой xAI API). |
...
| `grok_runtime` | Изменение браузерной автоматизации Grok, таймаутов или flow подготовки background/video; распространяется на оба пути — `api/grok_web.py` (Playwright) и `api/grok_video.py` (xAI API). |

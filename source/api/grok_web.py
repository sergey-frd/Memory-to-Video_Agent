...
class GrokWebAgent:
    ...
    def _write_debug_snapshot(self, page: Page, output_path: Path, reason: str, *, force: bool = False) -> dict[str, str]:
        if not self.config.save_debug_artifacts and not force:
            return {
